...
import { DataStructureService } from "../service/Model/DataStructureService";

export class DataStructureController {
	private dispatch: Dispatch<PayloadAction<any>>
	private service: DataStructureService

	constructor(dispatch: Dispatch<PayloadAction<any>>) {
		this.dispatch = dispatch
		this.service = new DataStructureService(this.dispatch)
	}

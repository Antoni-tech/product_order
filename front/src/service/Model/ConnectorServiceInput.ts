import { ConnectorInputRepositoryInstance } from "../../repository/Models/ConnectorInputRepository";
import { Dispatch } from "react";
import { PayloadAction } from "@reduxjs/toolkit";
import { ActionTypes } from "../../redux/Model/ConnectorInputReducer";


export class ConnectorServiceInput {
	private dispatch: Dispatch<PayloadAction<any>>
	private repository = ConnectorInputRepositoryInstance

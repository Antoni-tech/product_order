...
import { FaPen, FaRedo, FaTimesCircle, FaTrash } from "react-icons/fa";
 ...
 * @returns 
 */
export const RegistryListRowFunctionalButton: FC<{ cfg: RegistryListRowFunctionalButtonConfig }> = ({ cfg }) => {
